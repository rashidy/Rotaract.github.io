<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $password = mysqli_real_escape_string($db,$mypassword); 
...
<html dir="auto">
<head>
  <title><?php echo $lang['title'] ?>| District 2451</title>
...
<img src="img/rotaract.png" height="100" width="100">&nbsp;&nbsp;<img src="img/Rotary.png" class="working-image" height="100" width="100">
  <h1 style="color:darkred;font-size:30 "><?php echo $lang['greeting'] ?></h1>
  <p id="demo" style="color:darkred;font-size:25 "></p>
  <div style="text-align:right;margin-top:-10px;">
  <a href="http://localhost/rotaract/Rotary.php?lang=ar"><img src="img/ar.png"></a>&nbsp;&nbsp;&nbsp;
  <a href="http://localhost/rotaract/Rotary.php?lang=en"><img src="img/us.png"></a>&nbsp;&nbsp;
  <a href="http://localhost/rotaract/Rotary.php?lang=fr"><img src="img/fr.png"></a>&nbsp;&nbsp;
  <a href="http://localhost/rotaract/Rotary.php?lang=de"><img src="img/de.png"></a>
  <div>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03" >
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0 ml-auto" >
     ...
     <li class="nav-item " >
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="#cause" ><?php echo $lang['Activities'] ?></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="#Club-magazine"  ><?php echo $lang['Club Magazine'] ?></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="#Club-social-media"  ><?php echo $lang['Social media'] ?></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"  ><?php echo $lang['Donate Now'] ?></a>
      </li>
	   
	  <li class="nav-item">
       
	<a href="#" class="nav-link" onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><?php echo $lang['Sign in'] ?></a>
  ...
  <form class="modal-content animate" action="" method="post">
    ...
    <div class="container">
      <label for="uname"><b><?php echo $lang['username'] ?></b></label>
	   <p id="untext"><?php echo $lang['WARNING'] ?> </p>
	   <input id="myInput1" type="text" placeholder="<?php echo $lang['Enter Username'] ?>" name="uname" required>
     
	   
      <label for="psw"><b><?php echo $lang['password'] ?></b></label>
      <p id="pwdtext"><?php echo $lang['WARNING'] ?></p>
	  <input id="myInput2" type="password" placeholder="<?php echo $lang['Enter Password'] ?>" name="psw" required>
        
		 
      <button type="submit"><?php echo $lang['login'] ?></button>
       <div id="error" style = "font-size:11px; color:#cc0000; margin-top:10px"><?php echo $error; ?></div>
    </div>
    <div class="container" style="background-color:#f1f1f1">
      <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn"><?php echo $lang['cancel'] ?></button>
      <span class="psw"><a href="#"><?php echo $lang['forget password'] ?> </a></span>
    </div>
  </form>
</div>
      </li>
...
<div class="container"  style=" background-image:url(img/map.png);  background-position:center;background-repeat:no-repeat;max-width:100%; max-height:100%;background-size:cover;  text-align:center; margin:0;padding:0;"> 
 <div id="cause">
  <h1><?php echo $lang['our Activities'] ?></h1>
	</div>
	<div class="container" >
...
<div class="zoombox " >
	...
	<div class="zoomboxDiv ">
		<p style="Font-size:18;color:white;"><?php echo $lang['A1'] ?></p>
	</div><!--div-->
</div><!--zoombox-->
</div><!--col-4-->
...
<div class="zoominbox">
	<img src="img/Peace.jpg" class="zoomboximg">
	<div class="zoominDiv">
		<p style="Font-size:18;color:white;"><?php echo $lang['A2'] ?></p>
	</div><!--div-->
</div><!--zoombox-->
</div><!--col-4-->
<div class="col-sm-4">
...
<div class="zoominbox">
	<img src="img/Peace.jpg" class="zoomboximg">
	<div class="zoominDiv">
<p style="Font-size:18;color:white;"><?php echo $lang['A3'] ?></p>	</div><!--div-->
</div><!--zoombox-->
...
<div class="zoombox">
	<img src="img/Peace.jpg" class="zoomboximg">
	<div class="zoomboxDiv">
		<p style="Font-size:18;color:white;"><?php echo $lang['A4'] ?></p>
	</div><!--div-->
</div><!--zoombox-->
</div><!--col-4-->
<div class="col-sm-4">
<div class="zoominbox">
	<img src="img/Peace.jpg" class="zoomboximg">
	<div class="zoominDiv">
		<p style="Font-size:18;color:white;"><?php echo $lang['A5'] ?> </p>
	</div><!--div-->
</div><!--zoombox-->
</div><!--col-4-->
<div class="col-sm-4">
...
<div class="zoominbox">
	<img src="img/Peace.jpg" class="zoomboximg">
	<div class="zoominDiv">
		<p style="Font-size:18;color:white;"><?php echo $lang['A6'] ?></p>
	</div><!--div-->
</div><!--zoombox-->
...
<div class="container" style=" background-image:url(img/wall.jpg); background-position:center;background-repeat:no-repeat;max-width:100%; max-height:auto;background-size:cover;  text-align:center;margin:0;padding:0;margin-top:30px;">
  ...
  <h1 style="color:darkred; margin-top:20px;"> <?php echo $lang['Club Magazine'] ?> </h1>
    ...
    <div class="card-header" id="headingOne">
      <h2 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="text-decoration:none;color:darkred; 	">
           <div><?php echo $lang['march magazine'] ?></div>
        </button>
      </h2>
    </div>
...
<div class="container" style="">
  ...
  <h1 style="color:darkred; margin-top:20px;"> <?php echo $lang['social media'] ?> </h1>
	<h4 style="color:darkred; margin-top:30px;"> <?php echo $lang['follow us'] ?>  </h4>
...
<div class="container" style="background-color:#F8F8F8;max-width:100%;">
  <div id="Club-social-media">
  <h1 style="color:darkred; margin-top:20px;"> <?php echo $lang['Donate Now'] ?> </h1>
	<h4 style="color:darkred; margin-top:30px;"> <?php echo $lang['Donate title'] ?>  </h4>

<div class="container-som" style="background-image:url(img/donate.jpg); background-repeat:no-repeat; background-size:cover;">
...
<!-- stripe payment form -->
<form action="stripe-php/submit.php" method="POST" id="paymentFrm">
    <p>
        <label style="font-size:22px; color:black;"><b>Name</b></label>
        <input type="text" name="name" size="" />
    </p>
    <p>
        <label style="font-size:22px; color:black;"><b>Email</b></label>
        <input type="text" name="email" size="" />
    </p>
    <p>
        <label style="font-size:22px; color:black;"><b>Card Number</b></label>
        <input type="text" name="card_num" size="" autocomplete="off" 
class="card-number" />
    </p>
    <p>
        <label style="font-size:22px; color:black;"><b>CVC</b></label>
        <input type="text" name="cvc" size="" autocomplete="off" class="card-cvc" />
    </p>
    <p>
        <label style="font-size:22px; color:black;"><b>Expiration (MM/YYYY)</b></label>
        <input style="width:65px;" type="text" name="exp_month" size="4" class="card-expiry-month"/>
        <span> / </span>
        <input style="width:65px;" type="text" name="exp_year" size="4" class="card-expiry-year"/>
    </p>
...
<div class="jumbotron text-center " style="margin-bottom:0; " >
  <p style="text-align:center;color:#549EE8; font-family:Courier New ;font-size:19;"><?php echo $lang['copyrights'] ?> <sup> &copy; </sup>2020. </p>
