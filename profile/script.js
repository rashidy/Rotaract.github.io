...
// Toast Notification
    $(window).load(function() {
        setTimeout(function() {
            Materialize.toast('<span style="color:black;">Hello </span>', 1500);
        }, 1500);
        setTimeout(function() {
            Materialize.toast('<span style="color:black;">Don\'t forget our weekly meeting on friday at 01:00 PM</span>', 10000);
        }, 5000);
        setTimeout(function() {
            Materialize.toast('<img src="imgs/bell.png" height="35" width="35">&nbsp;&nbsp;<span style="color:black;"> Read the latest version of our magazine .</span><a class="btn-flat yellow-text" href="../magazine/march2020.pdf" target="_blanks">Read<a>', 10000);
        }, 15000);
    });
    ...
    $(function() {
      ...
      var companyPos = new google.maps.LatLng(40.6700, 37.9400);
...
function newElement() {
  ...
  li.appendChild(t);
  var element = document.getElementById("task-card");
  if (inputValue === '') {
    alert("You must write something!");
  } else {
    element.appendChild(li);
	
	element.appendChild(li).style.padding="30px";
  ...
  span.appendChild(txt);
  li.appendChild(span);
li.appendChild(span).style.margin="150px;" 
  for (i = 0; i < close.length; i++) {
    close[i].onclick = function() {
      var div = this.parentElement;
